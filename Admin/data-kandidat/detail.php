    ...
    <div class="col-md-10 p-5 pt-2"><br>
      ...
      <div class="col-md-10 p-1 pt-3 text-secondary">
             ...
             <form action="" method="post">
                <fieldset disabled>
                 <div class="mb-3">    
                     <label for="disabledTextInput" class="form-label text-dark">ID Kandidat</label>
                     <input type="text" name="id_kandidat" id="id_kandidat" required class="form-control" value="192010394">
                 </div>
                 <div class="mb-3">    
                     <label for="disabledTextInput" class="form-label text-dark">Nama Kandidat</label>
                     <input type="text" name="nama_kandidat" id="nama_kandidat" class="form-control" value="Ghaida Fasya">
                    </div>
                    
                    <div class="mb-3">    
                        <label for="inputpassword5" class="form-label text-dark">NPM</label>
                        <input type="text" name="npm" id="npm" class="form-control" value="714220031">
                       </div>
                       <div class="mb-3">    
                       ...
                       <div class="mb-3">    
                           ...
                           <select id="disabledSelect" class="form-label text-dark">
                            ...
                            <div class="mb-3">    
                                ...
                                <input type="text" name="visi_misi" id="visi_misi" class="form-control" value="...">
                            </div>
                        </div>
                        <div class="mb-3">    
